<template>
<uni-shadow-root class="chatflow-chatflow"><view style="height: 100vh">
  这里是小程序组件
</view></uni-shadow-root>
</template>

<script>
import ChatFlow from 'plugin://myPlugin/ChatFlow.vue'
global['__wxVueOptions'] = {components:{'ChatFlow': ChatFlow}}

global['__wxRoute'] = 'chatflow/chatflow'
...
export default global['__wxComponents']['chatflow/chatflow']
</script>
<style platform="mp-weixin">
/* miniprogram/pages/chatflow/chatflow.css */
/* page {
